...
public class manageAdmins extends javax.swing.JFrame {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(29, 29, 29)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(aID, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        try{
            ...
            int adminID = Integer.parseInt(aID.getText());
            String adminEmail = aEmail.getText();
            String adminPassword = aPassword.getText();
            String adminName = aName.getText();

            String SQL = "UPDATE admin SET eMail = '"+adminEmail+"', Password ='"+adminPassword+"', Name = '"+adminName+"' "
            + "WHERE ID ='"+adminID+"'";
            s.executeUpdate(SQL);
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        try{
            ...
            //if is available
            if(rSet.next()){
                aName.setText(rSet.getString("Name"));
                aPassword.setText(rSet.getString("Password"));
                aEmail.setText(rSet.getString("eMail"));
            }else{
